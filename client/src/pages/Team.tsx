  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      role: "Founder & CEO",
      image: "https://static.wixstatic.com/media/fd607a_c7b4b5600bee4440846ead34792c9f60~mv2.png/v1/crop/x_0,y_16,w_1200,h_1167/fill/w_225,h_219,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/1.png",
      linkedin: "https://www.linkedin.com/in/subham-subhadarshi-panda-119965171/",
    },
    {
      name: "Mr. Biswajeet Mishra",
      role: "CTO",
      image: "https://static.wixstatic.com/media/fd607a_408216eda7294ab28ab3eedb32229647~mv2.png/v1/fill/w_225,h_219,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/2.png",
      linkedin: "https://www.linkedin.com/in/biswajeet-mishra-0005141ba/",
    },
    {
      name: "Mr. Dipti Sundar Mohanty",
      role: "Director & Advisor",
      image: "https://static.wixstatic.com/media/fd607a_a09b41bce40c4ecf9a5683a05c8f7f21~mv2.png/v1/fill/w_225,h_219,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/3.png",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8 pt-24">
        ...
        <ScrollReveal>
          <p className="text-gray-400 text-center max-w-3xl mx-auto mb-16 text-lg">
            Meet the extraordinary people behind Thynx AI. Our team combines expertise in AI, 
