...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="py-24 lg:py-32 bg-black" data-testid="section-services">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-16">
            <ScrollReveal delay={0.1}>
              <p className="text-gray-400 max-w-md text-lg leading-relaxed">Transform your Innovative ideas into reality with our AI-powered ecosystem. From concept validation to market launch, Thynxai provides the tools, talent, and technology you need to succeed.</p>
            </ScrollReveal>
