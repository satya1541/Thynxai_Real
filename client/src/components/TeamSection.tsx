...
export default function TeamSection() {
  ...
  return (
    <section id="team" className="py-24 lg:py-32 bg-black" data-testid="section-team">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between mb-16">
          ...
          <ScrollReveal direction="right">
            <a
              href="#"
              className="flex items-center gap-2 text-white hover:text-fuchsia-400 transition-colors group"
