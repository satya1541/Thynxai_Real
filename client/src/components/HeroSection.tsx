...
import heroVideo from "@assets/hero-section-background-video.mp4";
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 text-center">
        <div className="flex flex-col items-center justify-center">
          <div className="text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-tight tracking-tight">
            ...
            <div
              className="flex flex-wrap items-center justify-center gap-x-4 md:gap-x-5 mt-2 md:mt-4"
              aria-hidden="true"
            >
            ...
            <div className="block mt-2 md:mt-4" aria-hidden="true">
